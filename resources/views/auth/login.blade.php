                ...
                <div class="w-full border-stroke dark:border-strokedark ">
                    <div class="w-full p-4 sm:p-12.5 xl:p-17.5">
                        <div class="flex flex-col items-center justify-center">
                            <span class="mb-1.5 block font-medium">Login</span>
                        ...
                        <form action="{{ route('login') }}" method="POST">
                            ...
                            <div class="mb-5.5 mt-5 flex items-center justify-between">
                                <label for="remember" class="flex cursor-pointer">
                                    <div class="relative pt-0.5">
                                        <input type="checkbox" name="remember" id="remember" {{ old('remember') ? 'checked' : '' }} class="taskCheckbox sr-only" />
